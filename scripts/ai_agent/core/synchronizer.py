...
class AgentSynchronizer:
    ...
    async def join_sync_point(
        ...
        try:
            ...
            await asyncio.wait_for(
                self._wait_for_sync_completion(sync_point),
                timeout=sync_point.timeout
            )
            return True
    ...
    def get_sync_status(self, sync_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'completion_time': sync_point.completion_time.isoformat() if sync_point.completion_time else None
        }
