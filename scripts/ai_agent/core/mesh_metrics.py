...
class MeshMetrics:
    ...
    def record_topology_change(
        self, old_config: Dict, new_config: Dict, reason: str
    ) -> None:
    ...
    def get_error_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "rates": {
                err_type: count / total for err_type, count in self.error_counts.items()
            },
        }
    ...
    def get_pattern_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "rates": {
                pattern: count / total for pattern, count in self.pattern_hits.items()
            },
        }
