...
class OptimizerAgent(BaseAgent):
    ...
    def __init__(
        self, name: str = "optimizer", config: Optional[Dict[str, Any]] = None
    ):
    ...
    def _analyze_resource_usage(self) -> Dict[str, Any]:
        ...
        for msg in resource_msgs:
            ...
            for resource, usage in resource_data.items():
                ...
                recent_usage = [u["value"] for u in self.resource_usage[resource][-10:]]
                if recent_usage:
    ...
    def _get_optimization_suggestion(
        ...
        suggestion = {"type": "optimization", "target": target, "actions": []}
            ...
            if current_value > 80:  # High CPU
                suggestion["actions"].extend(
                    [
                        ...
                        {
                            "action": "optimize_compute_intensive_operations",
                            "impact": "high",
                        },
                    ]
                )
            ...
            if current_value > 75:  # High memory
                suggestion["actions"].extend(
                    [
                        ...
                        {
                            "action": "optimize_memory_intensive_operations",
                            "impact": "high",
                        },
                    ]
                )
    ...
    def _validate_constraint(
        self, action: Dict[str, str], constraint: Dict[str, Any]
    ) -> bool:
    ...
    def _should_broadcast_health(self, summary: Dict[str, Any]) -> bool:
        ...
        return (
            summary.get("slo_status") == "breaching"
            or len(summary.get("critical_paths", [])) > 0
        )
    ...
    def _broadcast_health_status(self, summary: Dict[str, Any]) -> None:
        ...
        self.send_message(None, "system.health", health_status, priority="high")
