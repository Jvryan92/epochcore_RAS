...
class InvestmentCalculator:
    ...
    def calculate_single_scenario(
        ...
        annual_return = (
            (expected_outcome / initial_capital) ** (Decimal("1") / time_horizon) - 1
        ) * 100
    ...
    def calculate_required_growth_rate(
        ...
        growth_factor = (target_amount / initial_capital) ** (Decimal("1") / (periods))
        required_rate = (growth_factor - 1) * compound_frequency

        return required_rate.quantize(Decimal("0.0001"), rounding=ROUND_HALF_UP)
