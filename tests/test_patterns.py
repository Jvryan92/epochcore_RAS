...
class TestPatternGeneration:
    ...
    def test_meta_handlers_unified(self):
        ...
        complexity_task = StrategyTask(
            ...
            metadata={
                "complexity": 1.0,
                "execution_history": [{"success_rate": 0.8}, {"success_rate": 0.6}],
            },
        )
        ...
        optimize_task = StrategyTask(
            name="test_optimize",
            task_type=TaskType.RECURSIVE,
            metadata={"branches": 3, "optimization_level": 1},
            patterns=[
                TaskPattern(pattern_type="fractal", generator=fractal_task_generator)
            ],
        )
        ...
        assert (
            complexity_result["analyzed_complexity"] > 0.7
        )  # Should reflect average success rate
