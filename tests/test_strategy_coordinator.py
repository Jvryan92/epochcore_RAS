...
class TestStrategyCoordinator(unittest.TestCase):
    ...
    def test_register_strategy(self):
        ...
        self.assertEqual(
            self.coordinator.state.active_strategies["test"], mock_strategy
        )
    ...
    def test_dependency_order(self):
        ...
        self.assertEqual(self.coordinator.state.execution_order, ["a", "b", "c"])
    ...
    def test_error_handling(self):
        ...
        self.assertEqual(results["results"]["failing"]["status"], "error")
    ...
    async def test_async_execution(self, mock_create_task):
        ...
        self.assertEqual(results["results"]["async_test"]["status"], "async_success")
    ...
    def test_get_strategy_status(self):
        ...
        self.assertEqual(status["test"]["name"], "test")
